    ...
    return (
        <div className={styles.header}>
            <div className={styles.header__wrapper}>
                <div className={styles.header__logo}>NewMarket</div>

                <div className={styles.header__blocks}>
                    <Link className={styles.header__block} to='/categorys'>Все категории</Link>
                    {isUserAuth && user.isSuperuser && <Link className={styles.header__block} to={'/admin'}>Управление</Link>}

                    {isUserAuth && !user.isSuperuser ? 
                    <Link className={styles.header__block} to='/requests'>Мои заявки</Link>
                ...
                <div className={styles.header__icons}>
                    {isUserAuth && !user.isSuperuser &&
                        ...
                        <Link to={'/requests'} style={{pointerEvents: productsFromApplications.length === 0 ? 'none' : 'auto'}}>
                    ...
                    <div className={styles.burger__menu}>
                        <Link className={styles['burger__menu-item']} to={'/categorys'}>Категории</Link>
